...
export default function LandingPage() {
  return (
    <>
      <div className="relative  min-h-screen bg-gradient-to-tr from-[#183EC2] via-[#EAEEFE] to-[#EAEEFE]  min-[431px]:max-[810px]:overflow-hidden

">
        {/* Top Bar */}
        <div className="w-full bg-black text-gray-500 text-center text-sm py-2 max-[430px]:py-3">
          <span className='max-[430px]:hidden min-[431px]:max-[810px]:hidden'>This page is included in a free SaaS Website Kit.</span> <span className="text-gray-200 inline-flex items-center gap-1">View the complete Kit <ArrowRight size={14} /></span>
        </div>
        ...
        <nav className="flex justify-between items-center px-8 py-4 max-[430px]:hidden">
          ...
          <div className="flex items-center font-semibold gap-6 text-gray-500 text-base min-[431px]:max-[810px]:text-sm">
        ...
        <section className="relative flex items-center px-12 max-[430px]:px-8 py-20 max-[430px]:py-10 pb-32 max-[430px]:pb-[34rem] max-[430px]:flex-col ">
          {/* Left Side */}
          <div className="w-1/2 max-[430px]:w-full min-[431px]:max-[810px]:w-full">
            ...
            <h1 className="text-[90px] max-[430px]:text-[50px] font-bold text-black leading-tight max-[430px]:my-6  min-[431px]:max-[810px]:text-[80px] ">Pathway to <span className='text-[#001354]'>productivity</span></h1>
          ...
          {/* Right Side */}
          <div className="w-1/2 ">
            <Image src="/cylinder.png" alt="3D Design 1" width={200} height={200} className="absolute top-0 right-[34rem] max-[430px]:hidden min-[431px]:max-[810px]:right-[8rem]" />
            <Image src="/visual.png" alt="3D Design 2"
              width={600} height={600}

              className="absolute top-0 right-0 max-[430px]:top-[31rem]   min-[431px]:max-[810px]:-right-[20rem] " />
            <Image src="/half-torus.png" alt="3D Design 3" width={210} height={210} className="absolute -bottom-[6rem] right-5 max-[430px]:hidden  min-[431px]:max-[810px]:hidden" />
          </div>
        </section>
