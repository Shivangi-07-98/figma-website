...
export default function Footer() {
  return (
    <footer className="bg-black text-white py-8 px-4">
      <div className=" flex justify-between max-[430px]:flex-col max-[430px]:gap-14">
        {/* Left Section */}
        <div className="flex flex-col justify-between max-[430px]:gap-8">
          <div>
          <Image src="/logo.png" alt="Logo" width={50} height={50} />
          <p className="text-[#BCBCBC] text-sm max-w-[40%] mt-4 max-[430px]:max-w-full">
        ...
        {/* Right Section */}
        <div className="grid grid-cols-4 gap-12 justify-end mr-0 pr-0 max-[430px]:flex max-[430px]:flex-col max-[430px]:gap-6">
          <div>
